...
badd +0 cdma_reg_ral/reg_seq_item.sv
badd +287 cdma_reg_ral/reg_block_pkg.sv
badd +0 top/cdma_base_test.sv
badd +82 top/cdma_tb_top.sv
badd +0 ../riviera/sim_txt.log
badd +0 ../riviera/compile.log
badd +11 ../riviera/simulate.do
badd +21 axi_slave/slave_intf.sv
badd +3 axi_lite/master_intf.sv
badd +148 ../riviera/srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v
badd +318 axi_slave/slave_sequence.sv
...
silent! normal! zE
let s:l = 203 - ((13 * winheight(0) + 10) / 21)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 994 - ((9 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
994
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 618 - ((0 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
618
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 167 - ((8 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
167
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2811 - ((20 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2811
...
exe 'vert 1resize ' . ((&columns * 1 + 51) / 103)
exe 'vert 2resize ' . ((&columns * 99 + 51) / 103)
tabedit cdma_reg_ral/reg_seq_item.sv
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 22 - ((12 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
